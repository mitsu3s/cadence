  ...
  return (
    <div className="space-y-12 animate-fade-in">
      ...
      <div className="space-y-12 relative">
        {/* Connecting Line */}
        <div className="absolute left-6 top-6 bottom-6 w-px bg-zinc-800 -z-10 md:block hidden" />
        ...
        <div className="flex flex-col md:flex-row gap-8 relative">
          ...
          <div className="space-y-4 pt-2">
            <h3 className="text-2xl font-bold text-zinc-100">{t.steps.step1.title}</h3>
            <p className="text-zinc-400 leading-relaxed max-w-2xl">
              {t.steps.step1.description}
            </p>
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 max-w-xl">
        ...
        <div className="flex flex-col md:flex-row gap-8 relative">
          ...
          <div className="space-y-4 pt-2">
            <h3 className="text-2xl font-bold text-zinc-100">{t.steps.step2.title}</h3>
            <p className="text-zinc-400 leading-relaxed max-w-2xl">
        ...
        <div className="flex flex-col md:flex-row gap-8 relative">
          ...
          <div className="space-y-4 pt-2">
            <h3 className="text-2xl font-bold text-zinc-100">{t.steps.step3.title}</h3>
            <p className="text-zinc-400 leading-relaxed max-w-2xl">
